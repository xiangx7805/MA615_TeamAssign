...
temp%<>%
  ...
  ph_with_text(type = "body", index = 4, str ="1. Represents ownership in a firm 
...
3. Stockholders have claim on all assets" ) %>%
  ph_with_text(type = "body", index= 3, str = "4. Right to vote for directors and on certain issues
5. Two types
  - Common stock
       Right to vote
       Receive dividends
  - Preferred stock
       ...
       Do not usually vote")%>%
  ph_with_text(type = "sldNum", str = "Slide 01")
...
temp %<>% add_slide(layout = "Half Image Vertical Purple", master = master)%>%
  ...
  ph_with_text(type = "sldNum", str = "Slide 02")
...
temp %<>% add_slide(layout = "Half Image Horizontal", master = master)%>%
  ...
  ph_with_text(type = "sldNum", str = "Slide 03")
...
temp %<>% add_slide(layout = "Half Image Vertical Purple", master = master)%>%
  ...
  ph_with_text(type = "sldNum", str = "Slide 04")
```
...
temp %<>% 
  ...
  ph_with_text(type = "sldNum", str = "Slide 05")
...
temp %<>%
  ...
  ph_with_text(type = "body", index =2, str= "Sept. 30, 2002  Dow  7528
Jan. 5, 2004      Dow  10,568
Oct. 8, 2007      Dow   14093")%>%
  ph_with_text(type = "sldNum", str = "Slide 06")
```
...
temp %<>%
  ...
  ph_with_text(type = "body", index =2, str= "Decide whether this is a market correction or the start of something more
...
Check your portfolio for balance or the type of stocks you own")%>%
  ph_with_text(type = "sldNum", str = "Slide 07")
```
